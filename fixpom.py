...
DB_NAME = os.path.join(DATA_DIR, "fixpom.db")
...
# Global lock to serialize writes and prevent SQLite locking conflicts
...
# ==========================================
# DATABASE LAYER (WAL, CACHING & WRITE-LOCKS)
# ==========================================
...
# ==========================================
# OFFLOADED NON-BLOCKING QR GENERATION
# ==========================================
...
# ==========================================
# TEMPLATES (RESTYLED MODALS & RESPONSIVE UI)
# ==========================================
    ...
    <main class="flex-1 flex flex-col min-w-0 h-screen overflow-y-auto">
        ...
        <div class="p-4 md:p-8 max-w-5xl w-full mx-auto space-y-6">
            ...
            <form method="POST" action="/admin/save">
                ...
                <!-- TAB: MEDIA & GREETINGS (MULTIPLE VIDEO SELECT) -->
                <div id="tab-media" class="tab-content space-y-5 hidden">
                    ...
                    <!-- Direct Video File Upload with MULTIPLE File Selection -->
...
# Multiple Video Upload API Endpoint
...
async def upload_demo_video_file(
    ...
    try:
        ...
        logging.error(f"Multiple file upload error: {e}")
...
# Defensive Ban/Unban handler with database-lock protection
...
# Direct Accept / Reject for Orders via Admin Panel
